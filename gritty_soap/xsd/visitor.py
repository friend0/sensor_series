...
from pyOPC.gritty_soap import exceptions
from pyOPC.gritty_soap.exceptions import XMLParseError, ZeepWarning
from pyOPC.gritty_soap.parser import absolute_location
from pyOPC.gritty_soap.utils import as_qname, qname_attr
from pyOPC.gritty_soap.xsd import builtins as xsd_builtins
from pyOPC.gritty_soap.xsd import elements as xsd_elements
from pyOPC.gritty_soap.xsd import indicators as xsd_indicators
from pyOPC.gritty_soap.xsd import types as xsd_types
from pyOPC.gritty_soap.xsd.parser import load_external
...
class SchemaVisitor(object):
    ...
    def visit_complex_type(self, node, parent):
        ...
        qname = as_qname(name, node.nsmap, self.document._target_namespace)
        cls_attributes = {
            '__module__': 'gritty_soap.xsd.dynamic_types',
            '_xsd_name': qname,
        }
