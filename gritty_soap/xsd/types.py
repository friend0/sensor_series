...
from pyOPC.gritty_soap.exceptions import XMLParseError
from pyOPC.gritty_soap.xsd.elements import Element, Any
from pyOPC.gritty_soap.xsd.indicators import Sequence
from pyOPC.gritty_soap.xsd.utils import NamePrefixGenerator
...
class ComplexType(Type):
    ...
    def _value_class(self):
        return type(
            ...
            {'_xsd_type': self, '__module__': 'gritty_soap.objects'})
