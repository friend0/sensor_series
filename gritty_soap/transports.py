...
from pyOPC.gritty_soap.cache import SqliteCache
from pyOPC.gritty_soap.utils import NotSet, get_version
...
class Transport(object):
    ...
    def __init__(self, cache=NotSet, timeout=300, verify=True, http_auth=None):
        ...
        self.session.headers['User-Agent'] = (
            'Zeep/%s (www.python-gritty_soap.org)' % (get_version()))
    ...
    def post_xml(self, address, envelope, headers):
        ...
        and encoded as utf-8. See ``gritty_soap.wsdl.utils.etree_to_string``.
